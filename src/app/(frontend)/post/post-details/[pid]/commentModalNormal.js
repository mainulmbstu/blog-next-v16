...
const CommentModalNormal = ({ pid }) => {
  ...
  let clientAction = async () => {
    ...
    setLoading(true);
    await commentAction(pid, comment);
    setLoading(false);
    setComment("");
  };
  return (
    <div>
      ...
      <label htmlFor="CommentModalNormal" className="btn btn-success">
        {loading ? "Submitting" : "Comment on this post"}
      </label>

      {/* Put this part before </body> tag */}
      <input type="checkbox" id="CommentModalNormal" className="modal-toggle" />
      <div className="modal" role="dialog">
        <div className="modal-box">
          ...
          <div className="modal-action">
            <label htmlFor="CommentModalNormal" className="btn btn-error">
              Close
            </label>
            <label
              onClick={clientAction}
              htmlFor="CommentModalNormal"
...
export default CommentModalNormal;
